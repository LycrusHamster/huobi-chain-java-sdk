...
public class GovernanceService {
    ...
    public String get_admin_address() throws IOException {
        String statusList = muta.queryService(SERVICE_NAME, METHOD_GET_ADMIN_ADDRESS, null, new TypeReference<String>() {
        });
        return statusList;
    }

    public GovernanceInfo get_govern_info() throws IOException {
        GovernanceInfo governanceInfo = muta.queryService(SERVICE_NAME, METHOD_GET_GOVERN_INFO, null, new TypeReference<GovernanceInfo>() {
        });
        return governanceInfo;
    }

    public String get_tx_failure_fee() throws IOException {
        String ret = muta.queryService(SERVICE_NAME, METHOD_GET_TX_FAILURE_FEE, null, new TypeReference<String>() {
        });
        return ret;
    }

    public String get_tx_floor_fee() throws IOException {
        String ret = muta.queryService(SERVICE_NAME, METHOD_GET_TX_FLOOR_FEE, null, new TypeReference<String>() {
        });
        return ret;
    }

    public void set_admin(SetAdminPayload adminPayload) throws IOException {
        muta.sendTransactionAndPollResult(SERVICE_NAME, METHOD_SET_ADMIN, adminPayload, new TypeReference<Void>() {
        });
    }

    public void set_govern_info(SetGovernInfoPayload governInfoPayload) throws IOException {
        muta.sendTransactionAndPollResult(SERVICE_NAME, METHOD_SET_GOVERN_INFO, governInfoPayload, new TypeReference<Void>() {
        });
    }

    public void set_miner(MinerChargeConfig minerChargeConfig) throws IOException {
        muta.sendTransactionAndPollResult(SERVICE_NAME, METHOD_SET_MINER, minerChargeConfig, new TypeReference<Void>() {
        });
    }

    public void update_metadata(UpdateMetadataPayload updateMetadataPayload) throws IOException {
        muta.sendTransactionAndPollResult(SERVICE_NAME, METHOD_UPDATE_METADATA, updateMetadataPayload, new TypeReference<Void>() {
        });
    }

    public void update_validators(UpdateValidatorsPayload updateValidatorsPayload) throws IOException {
        muta.sendTransactionAndPollResult(SERVICE_NAME, METHOD_UPDATE_VALIDATORS, updateValidatorsPayload, new TypeReference<Void>() {
        });
    }

    public void update_interval(UpdateIntervalPayload updateIntervalPayload) throws IOException {
        muta.sendTransactionAndPollResult(SERVICE_NAME, METHOD_UPDATE_INTERVAL, updateIntervalPayload, new TypeReference<Void>() {
        });
    }

    public void update_ratio(UpdateRatioPayload updateRatioPayload) throws IOException {
        muta.sendTransactionAndPollResult(SERVICE_NAME, METHOD_UPDATE_RATIO, updateRatioPayload, new TypeReference<Void>() {
        });
    }
