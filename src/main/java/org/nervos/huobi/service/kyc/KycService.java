...
public class KycService {
  ...
  public KycOrgInfo get_org_info() throws IOException {
    KycOrgInfo kycOrgInfo =
        muta.queryService(
            SERVICE_NAME, METHOD_GET_ORG_INFO, null, new TypeReference<KycOrgInfo>() {});
    return kycOrgInfo;
  }
  ...
  public List<String> get_org_supported_tags() throws IOException {
    List<String> supported_tags =
        muta.queryService(
            SERVICE_NAME, METHOD_GET_ORG_SUPPORTED_TAG, null, new TypeReference<List<String>>() {});
  ...
  public boolean eval_user_tag_expression(EvalUserTagExpression evalUserTagExpression)
    ...
    boolean ret =
        muta.queryService(
            SERVICE_NAME, METHOD_EVAL_USER_TAG_EXPRESSION, null, new TypeReference<Boolean>() {});
    return ret;
  }
  ...
  public void change_service_admin(String new_admin) throws IOException {
    muta.sendTransactionAndPollResult(
        SERVICE_NAME, METHOD_CHANGE_SERVICE_ADMIN, new_admin, new TypeReference<Void>() {});
    return;
  }

  public void change_org_admin(ChangeOrgAdmin changeOrgAdmin) throws IOException {
    muta.sendTransactionAndPollResult(
        SERVICE_NAME, METHOD_CHANGE_ORG_ADMIN, changeOrgAdmin, new TypeReference<Void>() {});
    return;
  }
  ...
  public void update_user_tags(UpdateUserTags updateUserTags) throws IOException {
    muta.sendTransactionAndPollResult(
        SERVICE_NAME, METHOD_UPDATE_USER_TAGS, updateUserTags, new TypeReference<Void>() {});
    return;
  }
}
